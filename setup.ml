...
(* OASIS_START *)
(* DO NOT EDIT (digest: 95c2759519a1e43e1024756d7c03b4c3) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/ruhatch/mirage-btrees";
          synopsis =
            "An implementation of BTrees designed for use with MirageOS";
          description =
            Some
              [
                 OASISText.Para
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "5«\134{:x\137ªÀM®}ø\132;\001";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
